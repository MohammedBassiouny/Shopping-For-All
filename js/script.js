...
const product5=new products('HP Pavilion Laptop 15.6','380 $','Laptop','images/HP Pavilion Laptop 15.6.jpg',5);
const product6=new products('isolar R808','20 $','Radio','images/isolar R808.jpg',6);
const product7=new products('hp pavilion i7',' 330 $','Laptop','images/hp pavilion i7.jpg',7);
const product8=new products('Samsung Galaxy A54 ','170 $','Mobile','images/Samsung Galaxy A54 .jpg',8);
const product9=new products('RX-2070','100 $','Radio','images/RX-2070.jpg',9);

function draw(){
for(let i =1;i<product.length;i++){
    row.innerHTML+=`
    <div class="card col-lg-4 col-md-6 col-sm-12 mt-1 mb-1" style="width: 18rem;">
        <img src="${product[i].img}" class="card-img-top" height="350px" alt="product-1">
            <div class="card-body">
